...
/*   Updated: 2024/02/21 20:46:04 by emimenza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_check_arg(int argc, char **argv)
{
	if (ft_isnbr(argv[1]) == 1)
		return (printf("Error [number_of_philosophers] argument\n"), 1);
	if (ft_isnbr(argv[2]) == 1)
		return (printf("Error [time_to_die] argument\n"), 1);
	if (ft_isnbr(argv[3]) == 1)
		return (printf("Error [time_to_eat] argument\n"), 1);
	if (ft_isnbr(argv[4]) == 1)
		return (printf("Error [time_to_sleep] argument\n"), 1);
